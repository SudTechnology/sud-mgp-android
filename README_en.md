...
##### Standard Version SDK: SudMGP-Android-v1.3.7.1183.zip 
##### Lite Version SDK: SudMGP-Android-v1.3.7.1183-lite.zip 
##### Multilingual Speech Recognition Extension Library (Optional): SudMGP-Android-v1.3.7.1183.zip 
...
implementation 'tech.sud.mgp:SudMGP:1.3.7.1183'

// Multilingual Speech Recognition Extension Library (Optional)
implementation 'tech.sud.mgp:SudASR:1.3.7.1183'
```
#### Dependency on the Lite Version of SudMGP SDK
```ruby
// Lite Version SudMGP SDK
implementation 'tech.sud.mgp:SudMGP-lite:1.3.7.1183'
