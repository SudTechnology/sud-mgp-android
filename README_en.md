...
##### Standard Version SDK: SudMGP-Android-v1.4.3.1201.zip 
##### Lite Version SDK: SudMGP-Android-v1.4.3.1201-lite.zip 
##### Multilingual Speech Recognition Extension Library (Optional): SudMGP-Android-v1.4.3.1201.zip 
...
implementation 'tech.sud.mgp:SudMGP:1.4.3.1201'

// Multilingual Speech Recognition Extension Library (Optional)
implementation 'tech.sud.mgp:SudASR:1.4.3.1201'
```
#### Dependency on the Lite Version of SudMGP SDK
```ruby
// Lite Version SudMGP SDK
implementation 'tech.sud.mgp:SudMGP-lite:1.4.3.1201'
