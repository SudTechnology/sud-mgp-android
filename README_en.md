...
* **Standard SDK version**: SudGIP-Android-v1.6.8.1299.zip
* **Pro SDK version**: SudGIP-Android-v1.6.8.1299-pro.zip
* **Multilingual Speech Recognition Extension Library (optional)**: SudASR-Android-v1.6.8.1299.zip
